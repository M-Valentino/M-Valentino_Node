...
export const AUTO_COMPLETE_OPTIONS  = [
  {label: PROJECT_TITLES.earth3Js, id: 0},
  {label: PROJECT_TITLES.imageToDivs, id: 1},
  {label: PROJECT_TITLES.icat, id: 2},
  {label: PROJECT_TITLES.exploringCannyEdgeDetection, id: 3},
  {label: PROJECT_TITLES.iSpyShopper, id: 4},
  {label: PROJECT_TITLES.imageManipulationExperiments, id: 5},
  {label: PROJECT_TITLES.retroCalculator, id: 6},
  {label: PROJECT_TITLES.citiesRecommender, id: 7}
]
